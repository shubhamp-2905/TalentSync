...
export default function RegisterPage() {
    ...
    const handleRegisterSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if (userType === 'student') {
            ...
            formDataToSubmit.append('major', formData.major);
            if (resumeFile) {
                                ...
                                {userType === 'student' && (
                                    <>
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <Input id="resume" name="resume" type="file" required onChange={handleFileChange} accept=".pdf,.doc,.docx" />
                                            <p className="text-xs text-gray-500">We'll use this to auto-fill your profile!</p>
                                        </div>
                                    </>
                                )}
                                {userType === 'recruiter' && (
